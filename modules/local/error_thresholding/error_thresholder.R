...
##import data
##test data
#signature_matrix <-  'icgc-argo-mutational-signatures/error_thresholding/data/COSMIC_v2_SBS_GRCh38.txt'
#input_json <- 'icgc-argo-mutational-signatures/signaturetoolslib/tests/expected/test_assignments.json'
